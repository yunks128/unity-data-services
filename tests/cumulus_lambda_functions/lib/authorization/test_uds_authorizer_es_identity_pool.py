...
class TestUDSAuthorizorEsIdentityPool(TestCase):
    ...
    def test_02(self):
        ...
        self.assertEqual(put_authorized_list[0]['project'], 'unitty_project_2', 'wrong project for PUT GRANULES')
        self.assertEqual(put_authorized_list[0]['project_venue'], 'DEV_001', 'wrong venue for PUT GRANULES')
