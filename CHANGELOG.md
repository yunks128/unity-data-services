...
## [4.0.0] - 2023-06-13
### Changed
- [#15x](https://github.com/unity-sds/unity-data-services/pull/15x) breaking: search to return feature-collection. download to read feature-collection + return localized feature-collection w/ relative paths
